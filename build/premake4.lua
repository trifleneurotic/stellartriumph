...
solution "orxtest"
    ...
    configuration {"web"}
        ...
        buildoptions
        {
            "-DorxWEB_EXECUTABLE_NAME='\"orxtest.wasm\"'",
        ...
        linkoptions
        {
            "--preload-file " .. copybase .. "/build/orxtest.obr@/",
    ...
    configuration {"web", "Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && orxtest -b ../build/orxtest.obr"}
        postbuildcommands {"del " .. path.translate(copybase, "\\") .. "\\build\\orxtest.obr"}

    configuration {"web", "not Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && ./orxtest -b ../build/orxtest.obr"}
        postbuildcommands {"rm " .. copybase .. "/build/orxtest.obr"}
